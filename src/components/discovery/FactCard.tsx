    ...
    return (
      <Card 
        ...
        className={cn(
          ...
          "w-full max-w-none", // Ensure full width responsiveness
            ...
            <div className="flex-1 space-y-2 sm:space-y-3 min-w-0">
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <Button
                  ...
                  className="h-8 w-8 p-0 shrink-0 self-start"
                >
                  {isSaved ? (
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 pt-1">
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  ...
                  <Badge 
                    ...
                    className={cn(
                      "text-xs",
                      fact.media_urls && fact.media_urls.length > 0 && "hidden sm:inline-flex"
                    )}
                  >
                  ...
                  {fact.status === 'verified' && (
                    <Badge variant="ios" size="sm" className="hidden sm:inline-flex">
                      Verified
                    </Badge>
                  )}
                </div>
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  {fact.status === 'verified' && (
                    <Badge variant="ios" size="sm" className="sm:hidden">
                      ✓
                    </Badge>
                  )}
                </div>
  ...
  return (
    <Card 
      ...
      className={cn(
        ...
        "w-full max-w-sm mx-auto", // Responsive max width with auto centering
          ...
          <div className="relative h-44 sm:h-48 md:h-52 overflow-hidden">
            ...
            <div className="absolute top-3 right-3 flex gap-2">
              <Button
                ...
                size="sm"
                onClick={handleSaveToggle}
                className="h-8 w-8 p-0 bg-black/20 backdrop-blur-sm hover:bg-black/40 transition-all duration-200"
              >
                {isSaved ? (
            ...
            <div className="absolute bottom-3 left-3">
              <Badge 
                ...
                style={{ borderColor: fact.categories?.color }}
              >
                <span style={{ color: fact.categories?.color }} className="text-sm">
                  {fact.categories?.icon}
                </span>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-border/50">
            <div className="flex items-center gap-3">
              ...
              {/* Credibility Score */}
              {voteScore > 0 && (
                <Badge variant="chip" size="sm" className="bg-green-50 text-green-700 border border-green-200 dark:bg-green-950 dark:text-green-300">
                  +{voteScore}
                </Badge>
              )}
            </div>
