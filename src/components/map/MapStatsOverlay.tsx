...
export const MapStatsOverlay: React.FC<MapStatsOverlayProps> = ({
  ...
  return (
    <div className="fixed top-32 left-4 z-20">
      <div className="bg-background/95 backdrop-blur-sm border border-border rounded-lg shadow-lg min-w-[200px] overflow-hidden">
        {/* Header with toggle */}
        ...
        >
          <div className="p-4 space-y-3">
            ...
            <Badge variant="secondary" className="w-full justify-center mt-2 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              Live Updates Active
            </Badge>
          </div>
        </div>
