...
export const HeroSearchBarOptimized: React.FC<HeroSearchBarProps> = ({
  className,
  onSearch,
  onQueryChange,
  showTrending = true
  ...
  return (
    <div className={cn("w-full max-w-4xl mx-auto", className)}>
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 animate-hero-title">
          <span className="text-primary">Find</span>{" "}
          <span className="text-secondary">Local Lore</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-hero-subtitle">
          Share and uncover hidden stories, legends, and secrets in your neighborhood
        </p>
      </div>

      {/* Search Bar */}
      <div className="relative mb-8 animate-hero-search">
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div className="absolute z-50 w-full mt-2 animate-fade-in-fast">
      ...
      {/* Popular Categories */}
      <div className="mb-8 animate-hero-categories">
      ...
      {/* Trending Searches */}
      {showTrending && (
        <div className="text-center mb-8 animate-hero-trending">
      ...
      {/* Main Action Buttons */}
      <div className="flex flex-wrap justify-center gap-4 animate-hero-buttons">
        <Button 
...
export default HeroSearchBarOptimized;