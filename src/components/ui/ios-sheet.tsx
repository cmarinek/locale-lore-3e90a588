...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background border shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
>(({ side = "bottom", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {/* iOS-style drag indicator for bottom sheets */}
      {side === "bottom" && (
