  ...
  return <MainLayout>
      ...
      <div className="h-screen w-full flex flex-col">
        ...
        <div className="flex-shrink-0 p-4 border-b border-border/50 bg-background/95 backdrop-blur-sm">
          <div className="glass rounded-lg p-4 mb-4 mt-12 my-[40px] py-0">
          ...
          <div className="lg:w-1/3 flex-shrink-0 flex flex-col border-r border-border/50">
            ...
            <ScrollArea className="flex-1">
              <div className="p-4 space-y-3">
                ...
                {!loading && displayedFacts.length === 0 && <div className="text-center py-8 text-muted-foreground">
                    No stories found
                  </div>}
                
                {displayedFacts.map(fact => <div key={fact.id} onClick={() => handleFactClick(fact)} className="cursor-pointer">
                    <FactCard fact={{
                  ...fact,
                  distanceText: fact.distance ? formatDistance(fact.distance) : undefined
                }} viewMode="list" className="bg-card/50 backdrop-blur-sm hover:bg-card/70 transition-colors" />
                  </div>)}
              </div>
            </ScrollArea>
          </div>
