...
-- Vector similarity index for search embeddings
CREATE INDEX idx_search_analytics_embedding ON public.search_analytics USING ivfflat (query_embedding vector_cosine_ops);
