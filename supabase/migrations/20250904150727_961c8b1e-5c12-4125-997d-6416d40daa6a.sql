-- CRITICAL SECURITY FIX: Enable RLS on missing tables and secure functions
...
-- Fix search_path for user-defined functions only
-- We'll handle each of our known functions specifically
