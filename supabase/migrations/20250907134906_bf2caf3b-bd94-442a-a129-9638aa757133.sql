-- Fix 1: Create secure function to handle new user profile creation (if not exists)
...
-- Fix 2: Update all database functions to have proper search_path (security fix)
